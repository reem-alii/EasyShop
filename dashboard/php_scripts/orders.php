...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['action']) && $_GET['action'] == 'delete'){
    ...
    $stmt->execute();
    header('Location: http://'.$_SERVER ['HTTP_HOST'].'/dashboard/views_html/orders/index.php');
    exit;
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_GET['action']) && $_GET['action'] == 'update'){
    ...
    if(empty($errors_array)){
         ...
         header('Location: http://'.$_SERVER ['HTTP_HOST'].'/dashboard/views_html/orders/details.php?action=details&order_id='.$id);
         exit;
    }else{
...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['action']) && $_GET['action'] == 'refund'){
    ...
    header('Location: http://'.$_SERVER ['HTTP_HOST'].'/dashboard/views_html/orders/details.php?action=details&order_id='.$order_id);
    exit;
}
