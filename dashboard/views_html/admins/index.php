...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-outline-success" href="http://localhost/EasyShop/dashboard/views_html/admins/create.php">Create Admin <i class="fa-solid fa-user-plus"></i></a><br><br>
  ...
  <tbody>
    <?php
      foreach ($admins as $admin) {
        ...
        echo '<td>
              <a href="http://localhost/EasyShop/dashboard/views_html/admins/index.php?action=delete&adminid='.$admin['id'].'"
              ...
              <a href="http://localhost/EasyShop/dashboard/views_html/admins/edit.php?action=edit&adminid='.$admin['id'].'"
              ...
              <a href="http://localhost/EasyShop/dashboard/views_html/admins/show.php?action=show&adminid='.$admin['id'].'"
              class="btn btn-secondary btn-sm" data-inline="true" style="background-color: #7d9a74;">
