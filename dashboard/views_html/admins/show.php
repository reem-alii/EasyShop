        ...
        <div class="col-md-12">
          <div class="user">
            <div class="card">
               ...
               <p class="buttons">
                  <a href="http://localhost/EasyShop/dashboard/views_html/admins/index.php?action=delete&adminid=<?php echo $row['id']?>"
                  class="btn btn-secondary btn-sm confirm" data-inline="true">
                  <i class="fa-solid fa-user-xmark" style="color:black;"></i></a>
                  <a href="http://localhost/EasyShop/dashboard/views_html/admins/edit.php?action=edit&adminid=<?php echo $row['id']?>"
