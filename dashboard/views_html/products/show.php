        ...
        <div class="col-md-6">
            <div class="show des">
               <div class="card">
                 ...
                 <p class="text-center"><a href="http://localhost/EasyShop/dashboard/views_html/products/index.php?action=delete&prodid=<?php echo $row['id'] ; ?>"
                     ...
                     <a href="http://localhost/EasyShop/dashboard/views_html/products/edit.php?action=edit&prodid=<?php echo $row['id'] ; ?>"
