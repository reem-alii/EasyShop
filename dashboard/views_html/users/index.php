...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-outline-success" href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/users/create.php">Create User <i class="fa-solid fa-user-plus"></i></a><br><br>
      ...
      foreach ($users as $user) {
        ...
        if ($user['reg_status'] == 1 ){
          echo '<span class="badge badge-pill badge-success">Approved</span>';
            ...
            echo '<a href="http://'.$_SERVER ['HTTP_HOST'].'/EasyShop/dashboard/views_html/users/index.php?action=approve&userid='.$user['id'].'" class="badge badge-pill badge-warning">Not Approved </a>';
        }
        echo '</td>';
        echo '<td>
              <a href="http://'.$_SERVER ['HTTP_HOST'].'/EasyShop/dashboard/views_html/users/index.php?action=delete&userid='.$user['id'].'"
              ...
              <a href="http://'.$_SERVER ['HTTP_HOST'].'/EasyShop/dashboard/views_html/users/edit.php?action=edit&userid='.$user['id'].'"
              ...
              <a href="http://'.$_SERVER ['HTTP_HOST'].'/EasyShop/dashboard/views_html/users/show.php?action=show&userid='.$user['id'].'"
              class="btn btn-secondary btn-sm" data-inline="true" style="background-color: #7d9a74;">
