        ...
        <div class="col-md-12">
          <div class="user">
            <div class="card">
               ...
               <p><?php echo $stat ; ?></p>
               <p class="buttons">
                  <a href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/users/index.php?action=delete&userid=<?php echo intval($row['id'])?>"
                  class="btn btn-secondary btn-sm confirm" data-inline="true">
                  <i class="fa-solid fa-user-xmark" style="color:black;"></i></a>
                  <a href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/users/edit.php?action=edit&userid=<?php echo intval($row['id'])?>"
