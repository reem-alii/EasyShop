        ...
        <div class="col-md-12">
            <div class="show">
               <div class="card">
                 ...
                 ?>
                 <p class="text-center"><a href="http://localhost/dashboard/views_html/categories/index.php?action=delete&catid=<?php echo $row['id'] ; ?>"
                     ...
                     <a href="http://localhost/dashboard/views_html/categories/edit.php?action=edit&catid=<?php echo $row['id'] ; ?>"
