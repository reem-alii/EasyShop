...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-outline-success" href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/categories/create.php">Create Category <i class="fa-solid fa-tag"></i> </a><br><br>
    ...
    <?php foreach ($cats as $cat) { ?>
       ...
       <?php if($cat['parent_id'] == 0){ ?>
        ...
        ?>
            ...
            <td>
              <a href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/categories/index.php?action=delete&catid=<?php echo $cat['id']?>"
              ...
              <a href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/categories/edit.php?action=edit&catid=<?php echo $cat['id'] ?>"
              ...
              <a href="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/dashboard/views_html/categories/show.php?action=show&catid=<?php echo $cat['id'] ?>"
              class="btn btn-secondary btn-sm" data-inline="true" style="background-color: #7d9a74;">
