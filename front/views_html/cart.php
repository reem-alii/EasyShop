                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
                              <form action="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/front/views_html/cart.php" method="POST" style="display:flex;">
...
<?php if(!empty($carts)){ ?>
<form action="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/front/views_html/cart.php" method="POST" style="display:flex; margin-left: 655px;">
