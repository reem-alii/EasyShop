 ...
 <div class="container profile">
		<div class="main-body">
			<div class="row">
					...
					<div class="card">
						<div class="card-body">
                            ...
                            <div class="mt-3">
                                    ...
                                    <form action ="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/front/views_html/profile_edit.php" method="POST" enctype="multipart/form-data">
				...
				<div class="col-lg-8">
					<div class="card">
					  <form action="http://<?= $_SERVER ['HTTP_HOST'] ?>/EasyShop/front/views_html/profile_edit.php" method="POST">
						<div class="card-body">
