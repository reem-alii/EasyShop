...
include_once($_SERVER['DOCUMENT_ROOT']."/EasyShop/front/php_scripts/init.php");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['action'] == 'remove'){
        ...
        header("Location:http://".$_SERVER ['HTTP_HOST']."/EasyShop/front/views_html/cart.php");
    }
...
//}
  if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['action'] == 'order'){
    ...
    if($order['id']){
        ...
        unset($_SESSION['cart']);
        //emptyCart($id);
        header('Location:http://'.$_SERVER ['HTTP_HOST'].'/EasyShop/front/views_html/order_submit.php');
        exit;
    } 
    }else{
